...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, current_speed, waypoint, vehicle_transform):
        """
        Execute one step of control invoking both lateral and longitudinal PID controllers to reach a target waypoint
        at a given target_speed.

        :param target_speed: desired vehicle speed in Km/h
        :param current_speed: estimated vehicle speed in Km/h
        :param waypoint: target location encoded as a waypoint
        :param vehicle_transform: estimated vehicle rotation and translation
        :return: Vehicle control class for next step input
        """
        throttle = self._lon_controller.run_step(target_speed, current_speed)
        steering = self._lat_controller.run_step(waypoint, vehicle_transform)
